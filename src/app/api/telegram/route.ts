...
// Recibe mensajes de Telegram y responde automáticamente
...
async function handleCallback(callbackQuery: { message: { chat: { id: number } }; data: string; id: string }) {
...
async function handleMessage(message: { chat: { id: number }; text?: string; from?: { first_name?: string } }) {
...
// POST - Recibe webhooks de Telegram
...
export async function GET() {
  return new Response('Bot webhook activo ✅', { status: 200 });
}
